...
- 자산의 임차인, 사용 목적, 기업 분류의 **임차인 정보** 제공
- 임대료에 영향을 미치는 요인들을 제공하고 지도에 표시할 **지표**를 선택
